...
public class MybatisConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactoryBean(org.apache.ibatis.session.Configuration config) {
        ...
        //添加插件
        bean.setPlugins(new Interceptor[]{pageHelper, new SqlPrintInterceptor()});
        //添加XML目录
    ...
    public SqlSessionFactory sqlSessionFactorys() throws Exception {
        ...
        try {
            ...
            // 读取配置
            sessionFactoryBean.setTypeAliasesPackage("com.wpf.springboot.druidwriteread.domain");
